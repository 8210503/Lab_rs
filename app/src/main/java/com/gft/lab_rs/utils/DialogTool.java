...
public class DialogTool {
     ...
     * @return
     */
    public static Dialog createRandomDialog(Dialog dialog, Context context, String title,
    ...
    public static void requiredDialog(Context context, String title, final TextView textView){
        DialogTool.createConfirmDialog(context, "提示!", title+"为必填项,如果不填,默认填"+"'/'"+"\n"+"确定不填吗?", "确定", "取消", new DialogInterface.OnClickListener() {
            @Override
